...
interface IOrchestrator_v1 is IModuleManagerBase_v1 {
    ...
    /// @notice The {IPaymentProcessor_v3} implementation used to process module
    ///         payments.
    /// @return The {IPaymentProcessor_v3} implementation.
    function paymentProcessor() external view returns (IPaymentProcessor_v3);
