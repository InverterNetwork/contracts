 ...
 *
 * @dev     More user-friendly way to deploy a PIM workflow with a restricted bonding curve.
 *          Anyone can sponsor the required collateral supply for a bonding curve deployment.
