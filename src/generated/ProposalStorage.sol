...
// This file's extension is .t.sol to exclude it when the forge build command is run inside this script
...
contract ProposalStorage {
    ...
    uint[50] internal __Proposal___gap;
    mapping(address => uint) internal __Proposal__balances;
    mapping(address => mapping(address => uint)) internal __Proposal__allowances;
    uint internal __Proposal__totalSupply;
    string internal __Proposal__name;
    string internal __Proposal__symbol;
    uint[45] internal __Proposal___gap_2;
    address internal __Proposal__owner;
    uint[49] internal __Proposal___gap_3;
    bool internal __Proposal__paused;
    uint[49] internal __Proposal___gap_4;
    mapping(address => address) internal __Proposal__modules;
    uint internal __Proposal__moduleCounter;
    mapping(address => mapping(bytes32 => mapping(address => bool))) internal
        __Proposal__moduleRoles;
