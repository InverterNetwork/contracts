...
contract WhitelistCallerEscalationManager is BaseEscalationManager, Ownable {
    ...
    function setAssertingCallerInWhitelist(address assertingCaller, bool value)
        public
        onlyOwner
    {
        ...
        returns (AssertionPolicy memory)
    {
        return AssertionPolicy({
            blockAssertion: !whitelistedAssertingCallers[optimisticOracleV3.getAssertion(assertionId)
