...
contract Insurance {
    ...
    event InsurancePayoutRequested(
        bytes32 indexed policyId, bytes32 indexed assertionId
    );
    ...
    function issueInsurance(
        ...
        defaultCurrency.safeTransferFrom(
            msg.sender, address(this), insuranceAmount
        );
    ...
    function requestPayout(bytes32 policyId)
        public
    ...
    function _settlePayout(bytes32 assertionId) internal {
        ...
        defaultCurrency.safeTransfer(
            policy.payoutAddress, policy.insuranceAmount
        );
