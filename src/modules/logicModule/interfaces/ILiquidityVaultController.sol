...
interface ILiquidityVaultController {
    ...
    event FundingManagerChanged(
        IFM_BC_BondingSurface_Redeemable_Repayer_Seizable_v1 newFundingManager,
        IFM_BC_BondingSurface_Redeemable_Repayer_Seizable_v1 oldFundingManager
    );
    ...
    // todo
    function setRepayers(IRepayer_v1[] calldata _repayers) external;
