    ...
    RedeemingBondingCurveBase_v1
{
    ...
    function _setVirtualIssuanceSupply(uint _virtualSupply)
        ...
        override(VirtualIssuanceSupplyBase_v1)
    {
        uint minRequiredSupply;
        uint decimalDifference;

        if (issuanceTokenDecimals <= 18) {
            ...
            decimalDifference =
                18 - issuanceTokenDecimals == 0 ? 1 : 18 - issuanceTokenDecimals;
        } else {
            // If issuance token has more than 18 decimals
            decimalDifference = issuanceTokenDecimals - 18;
        }
        minRequiredSupply = 10 ** decimalDifference;
        ...
        if (_virtualSupply < minRequiredSupply) {
