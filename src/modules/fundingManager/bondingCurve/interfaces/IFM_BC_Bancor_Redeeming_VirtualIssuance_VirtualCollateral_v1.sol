...
interface IFM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1 {
    ...
    error BancorVirtualSupplyBondingCurveBase__InvalidReserveRatio();
    ...
    error BancorVirtualSupplyBondingCurveBase__InvalidTokenDecimal();

    error BancorVirtualSupplyBondingCurveBase__InvalidDepositAmount();
