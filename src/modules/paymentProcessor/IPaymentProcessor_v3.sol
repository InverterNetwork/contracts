...
interface IPaymentProcessor_v3 {
    //--------------------------------------------------------------------------
    // Errors
    ...
    /// @notice Processes all payments from an {IERC20PaymentClientBase_v3} instance. Please note:
    ...
    ///         payments.
    /// @param  client The {IERC20PaymentClientBase_v3} instance to process its to payments.
    function processPayments(IERC20PaymentClientBase_v3 client) external;

    /// @notice Cancels all unfinished payments from an {IERC20PaymentClientBase_v3} instance.
    /// @dev	It's up to the the implementation to keep up with what has been
    ///         paid out or not.
    /// @param  client The {IERC20PaymentClientBase_v3} instance to process its to payments.
    ...
    /// @param  client The IERC20PaymentClientBase_v3 instance address that processes all claims from _msgSender.
    /// @param  token address of the payment token.
    ...
    /// @param  order The IERC20PaymentClientBase_v3 Order that needs to be checked.
