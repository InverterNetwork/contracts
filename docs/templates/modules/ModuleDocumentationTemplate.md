...
_A high-level purpose and description of the contract._
...
_Use Mermaid `classDiagram` to create the UML Diagram of the Module_
...
sequenceDiagram
    ...
    participant bS as QuadraticPriceFormula Redeeming
...
The list of deployment parameters can be found in the _Technical Reference_ section of the documentation under the `init()` function ([link]).
