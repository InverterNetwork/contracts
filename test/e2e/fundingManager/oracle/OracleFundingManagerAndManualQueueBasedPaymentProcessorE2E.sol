    ...
    E2ETest
{
    ...
    uint constant PROTOCOL_FEE = 100; // 1%
    ...
    function test_e2e_QueueBaseFundingManagerAndPaymentProcessorNoProtocolFeeLifecycle(
    ) public {
        _init();
        //--------------------------------------------------------------------------
        // Buy Tokens
    ...
    // function test_e2e_QueueBaseFundingManagerAndPaymentProcessorWithProtocolFeeLifecycle(
    // ) public {
    //     _init();
    //     // Set protocol fee for buy to 1%
    //     feeManager.setCollateralWorkflowFee(
    //         address(orchestrator),
    //         address(fundingManager),
    //         bytes4(keccak256(bytes("buy(uint256,uint256)"))),
    //         true,
    //         PROTOCOL_FEE
    //     );
    ...
    //     // Set protocol fee for sell to 1%
    //     feeManager.setCollateralWorkflowFee(
    //         address(orchestrator),
    //         address(fundingManager),
    //         bytes4(keccak256(bytes("sell(uint256,uint256)"))),
    //         true,
    //         PROTOCOL_FEE
    //     );
    //     feeManager.setIssuanceWorkflowFee(
    ...
    //     address protocolTreasury = feeManager.getDefaultProtocolTreasury();
    //     // Validate fees are set correctly
    //     {
    //         (uint collateralFeeForBuy,) = feeManager
    ...
    //             collateralFeeForBuy,
    //             PROTOCOL_FEE,
    //             "Collateral fee should be 100"
    //         );
    //         (uint issuanceFeeForBuy,) = feeManager
    ...
    //         );
    //         assertEq(
    //             issuanceFeeForBuy, PROTOCOL_FEE, "Issuance fee should be 100"
    //         );
    //         (uint collateralFeeForSell,) = feeManager
    //             .getCollateralWorkflowFeeAndTreasury(
    //             address(orchestrator),
    //             address(fundingManager),
    //             bytes4(keccak256(bytes("sell(uint256,uint256)")))
    //         );
    //         assertEq(
    //             collateralFeeForSell,
    //             PROTOCOL_FEE,
    //             "Collateral fee should be 100"
    //         );
    //         (uint issuanceFeeForSell,) = feeManager
    //             .getIssuanceWorkflowFeeAndTreasury(
    //             address(orchestrator),
    //             address(fundingManager),
    //             bytes4(keccak256(bytes("sell(uint256,uint256)")))
    //         );
    //         assertEq(
    //             issuanceFeeForSell, PROTOCOL_FEE, "Issuance fee should be 100"
    //         );
    //         (uint collateralFeeForProcessPayments,) = feeManager
    //             .getCollateralWorkflowFeeAndTreasury(
    //             address(orchestrator),
    //             address(paymentProcessor),
    //             bytes4(keccak256(bytes("processPayments(address)")))
    //         );
    //         assertEq(
    //             collateralFeeForProcessPayments,
    //             PROTOCOL_FEE,
    //             "Collateral fee should be 100"
    //         );
    //     }
    ...
    //     uint expectedCollateralProtocolFeeForBuy;
    //     {
    //         uint netAmountForBuy;
    //         (netAmountForBuy, expectedCollateralProtocolFeeForBuy,) =
    //         _calculateNetAndSplitFees(
    //             buyAmount, PROTOCOL_FEE, fundingManager.buyFee()
    //         );

    //         uint netIssuanceAmountFromBuy;
    //         uint expectedIssuanceProtocolFeeForBuy;
    //         (netIssuanceAmountFromBuy, expectedIssuanceProtocolFeeForBuy,) =
    //         _calculateNetAndSplitFees(
    //             _issueTokensFormulaWrapper(netAmountForBuy), PROTOCOL_FEE, 0
    //         );
    ...
    //             expectedCollateralProtocolFeeForBuy,
    //             "protocol treasury should have the collateral protocol fee"
    //         );

    //         assertEq(
    //             issuanceToken.balanceOf(protocolTreasury),
    //             expectedIssuanceProtocolFeeForBuy,
    //             "protocol treasury should have the issuance protocol fee"
    //         );
    //     }
    ...
    //     // Sell Tokens
    //     //--------------------------------------------------------------------------
    //     uint expectedCollateralProtocolFeeForSell;
    //     uint netCollateralAmountFromSell;
    //     {
    //         uint sellAmount = expectedIssuedTokens;
    ...
    //         // Get expected protocol issuance fee for sell
    //         uint netIssuanceAmountForSell;
    //         uint expectedIssuanceProtocolFeeForSell;
    //         (netIssuanceAmountForSell, expectedIssuanceProtocolFeeForSell,) =
    //             _calculateNetAndSplitFees(sellAmount, PROTOCOL_FEE, 0);

    //         // Get expected protocol collateral fee for sell
    //         (netCollateralAmountFromSell, expectedCollateralProtocolFeeForSell,)
    //         = _calculateNetAndSplitFees(
    //             _redeemTokensFormulaWrapper(netIssuanceAmountForSell),
    //             PROTOCOL_FEE,
    ...
    //     assertEq(
    //         collateralToken.balanceOf(projectTreasury),
    //         buyAmount - expectedCollateralProtocolFeeForBuy,
    //         "project treasury should all the collateral from the buy amount"
    //     );
    ...
    //     assertEq(order.client_, data.paymentClient_, "Should be the same");
    //     assertEq(paymentOrder.recipient, data.receiver_, "Should be the same");
    //     // payment order amount has the protocol fee included
    //     assertEq(
    //         paymentOrder.amount,
    //         netCollateralAmountFromSell + expectedCollateralProtocolFeeForSell,
    //         "Should be the same"
    //     );
    //     // emitted redemption amount does not have the protocol fee included
    //     assertEq(
    //         data.finalRedemptionAmount_,
    //         netCollateralAmountFromSell,
    //         "Should be the same"
    //     );
    //     assertEq(
    //         paymentOrder.paymentToken,
    ...
    //     // Verify project treasury has all the buy amount minus
    //     // redemption amount and protocol fee
    //     assertEq(
    //         collateralToken.balanceOf(projectTreasury),
    //         buyAmount - openRedemptionAmount
    //             - expectedCollateralProtocolFeeForBuy,
    ...
    //     // Verify user has the right amount of collateral tokens after queue execution
    //     // ie. the protocol fee is not included in the amount
    //     assertEq(
    //         collateralToken.balanceOf(whitelistedUser),
    //         netCollateralAmountFromSell,
    //         "User should have the right amount of collateral tokens after queue execution"
    ...
    //     );
    //     console.log(
    //         "expectedCollateralProtocolFeeForSell",
    //         expectedCollateralProtocolFeeForSell
    //     );
    //     console.log(
    //         "collateralToken.balanceOf(whitelistedUser)",
    ...
    function _calculateNetAndSplitFees(
        uint totalAmount_,
        uint protocolFeePercentage_,
        uint projectFeePercentage_
    )
        internal
        returns (uint netAmount, uint protocolFeeAmount, uint projectFeeAmount)
    {
        // Calculate protocol fee amount if applicable
        if (protocolFeePercentage_ > 0) {
            protocolFeeAmount = totalAmount_ * protocolFeePercentage_ / BPS;
        }
        // Calculate project fee amount if applicable
        if (projectFeePercentage_ > 0) {
            projectFeeAmount = totalAmount_ * projectFeePercentage_ / BPS;
        }

        netAmount = totalAmount_ - protocolFeeAmount - projectFeeAmount;
    }
        ...
        returns (uint mintAmount_)
    {
        ...
        mintAmount_ = depositAmount_ * (10 ** collateralToken.decimals())
            / permissionedOracle.getPriceForIssuance();

        // Convert mint amount to issuance token decimals.
        mintAmount_ = FM_BC_Tools._convertAmountToRequiredDecimal(
            mintAmount_, collateralToken.decimals(), issuanceToken.decimals()
        );
    }
        ...
        returns (uint redeemAmount_)
    {
        ...
        uint collateralDecimalsConverterdDepositAmount = FM_BC_Tools
            ...
            depositAmount_, issuanceToken.decimals(), collateralToken.decimals()
        );

        // Calculate the redeem amount.
        redeemAmount_ = (
            permissionedOracle.getPriceForRedemption()
