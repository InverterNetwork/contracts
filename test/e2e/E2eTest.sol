...
contract E2eTest is Test {
    ...
    IProposalFactory.ModuleConfig authorizerFactoryConfig = IProposalFactory
        .ModuleConfig(authorizerMetadata, abi.encode(address(this), hasDependency, dependencies));
    ...
    IProposalFactory.ModuleConfig(streamingPaymentProcessorMetadata, abi.encode(hasDependency, dependencies));
    ...
    IProposalFactory.ModuleConfig(
        ...
        abi.encode(100_000_000, 1_000_000, makeAddr("treasury"), hasDependency, dependencies)
    );
    ...
    IProposalFactory.ModuleConfig(
        recurringPaymentManagerMetadata, abi.encode(1 weeks, hasDependency, dependencies)
    );
    ...
    function _createNewProposalWithAllModules(
        ...
        IProposalFactory.ModuleConfig(
            rebasingFundingManagerMetadata, abi.encode(address(config.token), hasDependency, dependencies)
        );
