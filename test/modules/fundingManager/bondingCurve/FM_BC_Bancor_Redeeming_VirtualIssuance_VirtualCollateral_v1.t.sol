...
import {FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Mock} from
    "test/modules/fundingManager/bondingCurve/mocks/FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Mock.sol";
...
contract FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Test is ModuleTest {
    ...
    FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Mock bondingCurveFundingManager;
    address formula;
    ...
    function setUp() public {
        ...
        address impl =
            address(new FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Mock());

        bondingCurveFundingManager =
        FM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1Mock(Clones.clone(impl));
    ...
    function testSupportsInterface() public {
        assertTrue(
            bondingCurveFundingManager.supportsInterface(
                type(IFM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1).interfaceId
            )
        );
    }
        ...
        callerIsOrchestratorOwner
    {
        ...
        vm.expectRevert(
            IVirtualIssuanceSupplyBase
                .VirtualIssuanceSupply__VirtualSupplyCannotBeZero
                .selector
        );
    ...
    */
        ...
        callerIsOrchestratorOwner
    {
        vm.expectRevert(
            IFM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1
                .BancorVirtualSupplyBondingCurveBase__InvalidReserveRatio
                .selector
        );
    ...
    */
    function testSetDecimals_FailsIfLowerThanSeven(uint8 _newDecimals) public {
        ...
        vm.expectRevert(
            IFM_BC_Bancor_Redeeming_VirtualIssuance_VirtualCollateral_v1
                .BancorVirtualSupplyBondingCurveBase__InvalidTokenDecimal
                .selector
        );
    ...
    */
    function testStaticPriceWithSellReserveRatioNonFuzzing() public {
        ...
        assertLt(_virtualIssuanceSupplyAfterSell, _virtualIssuanceSupplyBeforeSell);
        assertLt(
            _virtualCollateralSupplyAfterSell,
            _virtualCollateralSupplyBeforeSell
        );
