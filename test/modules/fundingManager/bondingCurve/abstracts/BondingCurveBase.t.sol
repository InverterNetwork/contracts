...
import {
    ...
    "test/modules/fundingManager/bondingCurve/mocks/BondingCurveBaseMock.sol";
...
contract BondingCurveBaseTest is ModuleTest {
    ...
    function setUp() public {
        ...
        bondingCurveFundingManager =
            BondingCurveBaseMock(Clones.clone(impl));
    ...
    */
    function testValidReceiver_FailsForInvalidAddresses() public {
        ...
        vm.expectRevert(
            IBondingCurveBase
                .BondingCurveBase__InvalidRecipient
                .selector
        );
    ...
    */
    function testBuyOrder_FailsIfDepositAmountIsZero() public {
        ...
        vm.expectRevert(
            IBondingCurveBase
                .BondingCurveBase__InvalidDepositAmount
                .selector
        );
    ...
    */
        ...
        callerIsOrchestratorOwner
    {
        vm.expectRevert(
            IBondingCurveBase
                .BondingCurveBase__BuyingAlreadyOpen
                .selector
        );
    ...
    */
        ...
        callerIsOrchestratorOwner
    {
        ...
        vm.expectRevert(
            IBondingCurveBase
                .BondingCurveBase__BuyingAlreadyClosed
                .selector
        );
        bondingCurveFundingManager.closeBuy();
    }
    ...
    */
        ...
        callerIsOrchestratorOwner
    {
        ...
        vm.expectRevert(
            IBondingCurveBase
                .BondingCurveBase__InvalidFeePercentage
                .selector
        );
