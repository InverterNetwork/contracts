...
import {VirtualCollateralSupplyBaseMock} from
    "test/modules/fundingManager/bondingCurve/utils/mocks/VirtualCollateralSupplyBaseMock.sol";
...
contract VirtualCollateralSupplyBaseTest is Test {
    ...
    function testAddCollateralAmountFails(uint amount) external {
        ...
        vm.expectRevert(
            IVirtualCollateralSupplyBase
                .VirtualCollateralSupplyBase_AddResultsInOverflow
                .selector
        );
        virtualCollateralSupplyBase.addVirtualCollateralAmount(amount);
    ...
    function testSubCollateralAmountFailsIfUnderflow(uint amount) external {
        ...
        vm.expectRevert(
            IVirtualCollateralSupplyBase
                .VirtualCollateralSupplyBase__SubtractResultsInUnderflow
                .selector
        );
        virtualCollateralSupplyBase.subVirtualCollateralAmount(amount);
    }
