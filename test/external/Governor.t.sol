...
contract GovernorTest is Test {
        ...
        if (adr == address(0)) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__InvalidAddress.selector, adr
                )
            );
        }
    ...
    function testValidTimelockPeriod(uint amt) public {
        if (amt < 48 hours) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__InvalidTimelockPeriod.selector, amt
                )
            );
        }
    ...
    function testAccessibleBeacon(uint seed, address target) public {
        ...
        if (shouldFail) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__BeaconNotAccessible.selector, target
                )
            );
        }
    ...
    function testOnlyCommunityOrTeamMultisig(address sender) public {
        if (
            ...
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__OnlyCommunityOrTeamMultisig.selector
                )
            );
        }
    ...
    function testUpgradeProcessAlreadyStarted(bool processStarted) public {
        if (processStarted) {
            ...
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__UpgradeProcessNotStarted.selector
                )
            );
        }
    ...
    function testTimelockPeriodExceeded(uint seed1, uint seed2) public {
        ...
        if (seed2 < timelockPeriod) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__TimelockPeriodNotExceeded.selector
                )
            );
        }
    ...
    function testInitModifierInPosition() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IGovernor.Govenor__InvalidAddress.selector, address(0)
            )
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IGovernor.Govenor__InvalidTimelockPeriod.selector, 0
            )
        );
    ...
    function testUpgradeBeaconWithTimelockModifierInPosition() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IGovernor.Govenor__BeaconNotAccessible.selector, address(0)
            )
        );
        vm.prank(communityMultisig);
    ...
    function testInitiateBeaconShutdownModifierInPosition() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IGovernor.Govenor__BeaconNotAccessible.selector,
    ...
    function testAcceptOwnership(uint seed, address target) public {
        ...
        if (shouldFail) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IGovernor.Govenor__CallToTargetContractFailed.selector
                )
            );
        }
        vm.prank(address(communityMultisig));
