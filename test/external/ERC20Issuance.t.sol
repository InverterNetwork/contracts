...
contract ERC20IssuanceTest is Test {
    ...
    function setUp() public {
        ...
        token.init("Test Token", "TT", 18, type(uint).max - 1, address(this));
    }
    ...
    */
    function testMintFails_IfCallerNotMinter() public {
        ...
        {
            vm.expectRevert(
                IERC20Issuance.IERC20Issuance__CallerIsNotMinter.selector
            );
    ...
    function testMintFails_IfMintExceedsMaximumSupply() public {
        ...
        vm.expectRevert(
            IERC20Issuance.IERC20Issuance__MintExceedsSupplyCap.selector
        );
