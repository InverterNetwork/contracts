...
contract DeployPP_Simple_v1 is Script {
    ...
    function run() external returns (address) {
        ...
        {
            // Deploy the PP_Simple_v1.

            paymentProcessor = new PP_Simple_v1();
        }

        vm.stopBroadcast();

        // Log the deployed PP_Simple_v1 contract address.
        console2.log(
            "Deployment of PP_Simple_v1 Implementation at address",
