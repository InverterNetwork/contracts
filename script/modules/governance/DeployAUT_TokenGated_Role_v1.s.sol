...
contract DeployAUT_TokenGated_Role_v1 is Script {
    ...
    AUT_TokenGated_Role_v1 tokenRoleAuthorizer;
    ...
    function run() external returns (address) {
        vm.startBroadcast(deployerPrivateKey);
        {
            ...
            tokenRoleAuthorizer = new AUT_TokenGated_Role_v1();
        }
        ...
        console2.log(
            "Deployment of AUT_TokenGated_Role_v1 Implementation at address",
