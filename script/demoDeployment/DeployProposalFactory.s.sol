...
import {ProposalFactoryDemo} from "src/demoContracts/ProposalFactoryDemo.sol";

/**
 * @title ProposalFactoryDemo Deployment Script
 *
 * @dev Script to deploy a new ProposalFactoryDemo.
 *
...
contract DeployProposalFactory is Script {
    ...
    ProposalFactoryDemo proposalFactory;
        ...
        returns (address)
    {
        ...
        {
            // Deploy the proposalFactory.
            proposalFactory = new ProposalFactoryDemo(target, moduleFactory);
        }
