...
contract DeploymentScript is Script {
    ...
    function run() public virtual returns (address factory) {
        ...
        (forwarderBeacon, forwarder) = deployAndSetupInverterBeacon_v1
            ...
            reverter, address(governor), forwarderImplementation, 1, 0, 0
        );
        ...
        console2.log("Deploy Module Factory \n");
        ...
        console2.log("Init Module Factory \n");
        ...
        console2.log("Deploy and init Orchestrator Factory \n");
