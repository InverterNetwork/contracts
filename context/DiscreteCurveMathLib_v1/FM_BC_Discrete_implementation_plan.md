...
- [ ] 5. Override `_getFunctionFeesAndTreasuryAddresses` to use cached protocol fees (from `_protocolFeeCache` struct) and project fees (from `buyFee`/`sellFee` state vars).
